...
public class ServerJFrameGUI extends GUI
{
	...
	private void generateMessages(Event theEvent)
	{
		...
		case Event.EVENT_MOVE:
			player = myData.getPlayer(theEvent.flags[0]);
		...
		case Event.EVENT_HANDOFF:
			player = myData.getPlayer(theEvent.flags[0]);
			Player player2 = myData.getPlayer(theEvent.flags[1]);
		...
		case Event.EVENT_CHECK:
			player = myData.getPlayer(theEvent.flags[0]);
			player2 = myData.getPlayer(theEvent.flags[1]);
