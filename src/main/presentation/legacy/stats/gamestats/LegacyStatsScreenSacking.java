...
public class LegacyStatsScreenSacking extends AbstractLegacyStatsScreenChecking
{
	private static final long serialVersionUID = -6223274103134556039L;

	public LegacyStatsScreenSacking(ActionListener listener)
	{
		super(ImageType.SCREEN_STATS_CHK_SACK, listener);
	}
	...
	protected void paintText(Graphics2D graphics)
	{
		...
		for (int i = 0; i < topPlayers.size(); i++)
		{
			...
			Color teamColor = new Color(Integer.valueOf(statsStrings[3]));
	...
	protected void setTopThree(StatsTable playerStatsTable, StatsTable teamStatsTable)
	{
		...
		topPlayers = playerStatsTable.getTopPlayers(3, Stats.STATS_SACKS_FOR, false, StatsTableRow.STATS_PLAYER_NAME, StatsTableRow.STATS_TEAM_NAME,
				Stats.STATS_SACKS_FOR, StatsTableRow.STATS_COLOR_FG_RGB);
