...
public class OldGamePanel extends AbstractScreenPanel implements MouseListener, MouseMotionListener
{
	...
	public OldGamePanel(int width, int height, ActionListener listener)
	{
		this(new Dimension(width, height), listener);
	}

	// TODO: figure out how this, GameDisplayPanel, and LegacyGraphicsGUI are related
	public OldGamePanel(Dimension dimension, ActionListener listener)
	{
		super(dimension);
