...
public class LegacyColorReplacer extends AbstractColorReplacer
{
	...
	private static LegacyColorReplacer instance = null;
	
	private LegacyColorReplacer()
	{
		colorMap = new InGameColorMap();
	}
	
	public static LegacyColorReplacer getInstance()
	{
		if (instance == null)
			instance = new LegacyColorReplacer();
