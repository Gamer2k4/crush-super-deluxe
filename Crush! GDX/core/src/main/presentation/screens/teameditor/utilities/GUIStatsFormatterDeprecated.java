...
@Deprecated
public class GUIStatsFormatterDeprecated
{
	...
	private GUIStatsFormatterDeprecated()
	{
	...
	{
		return (currentPlayer == null || currentPlayer.getRace() == null) ? "" : currentPlayer.getRace().name();
	}
